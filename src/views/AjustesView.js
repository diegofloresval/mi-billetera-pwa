...
const S = {
  ...
  pillBtnHoja: { padding: "8px 16px", borderRadius: 99, border: "none", background: C.hoja, color: "#fff", fontWeight: 800, fontSize: 12, cursor: "pointer" },
  ...
  addBtn: { marginTop: 10, width: "100%", padding: "10px 16px", borderRadius: 99, border: "none", background: C.hoja, color: "#fff", fontWeight: 800, fontSize: 13, cursor: "pointer" },
  ...
  fxSaveBtn: { padding: "0 18px", height: 40, borderRadius: 99, border: "none", background: C.hoja, color: "#fff", fontWeight: 800, fontSize: 13, cursor: "pointer" },
